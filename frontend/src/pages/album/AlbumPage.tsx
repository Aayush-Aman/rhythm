...
const AlbumPage = () => {
	...
	const {currentSong,isPlaying,playAlbum,togglePlay}= useMusicPlayer();

	//fetching the albums from the backend 
	useEffect(() => {
	...
	//logic for playing the album when the play button is clicked
	...
	//logic for play and pause button of the song
